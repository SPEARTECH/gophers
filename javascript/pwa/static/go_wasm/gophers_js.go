...
func aggFromJS(v js.Value) (g.Aggregation, error) {
	...
	if v.Type() == js.TypeObject && v.Get("op").Truthy() && v.Get("col").Truthy() {
		...
		case "collectlist":
			return g.CollectList(col), nil
		case "collectset":
			return g.CollectSet(col), nil
		default:
	...
	if v.Type() == js.TypeString {
		...
		if s == "" {
			return g.Aggregation{}, fmt.Errorf("empty aggregation spec")
		}
...
func dfObject(id int) js.Value {
	...
	obj.Set("Column", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		// Special-case: UDF spec (JS-side execution, but exposed as a standalone function gophers.UDF)
	...
	obj.Set("GroupBy", js.FuncOf(func(this js.Value, args []js.Value) any {
		df := get(id)
		if df == nil {
			return "error: dataframe handle invalid"
		}
		if len(args) < 1 || args[0].Type() != js.TypeString {
		...
		return js.FuncOf(func(this js.Value, args []js.Value) any {
			...
			helper.Set("ChartID", js.FuncOf(func(this js.Value, a []js.Value) any {
				...
				obj.Set("ElementID", js.FuncOf(func(this js.Value, b []js.Value) any {
					if len(b) < 1 || b[0].Type() != js.TypeString {
						return "error: ElementID(containerId)"
					}
					doc := js.Global().Get("document")
...
func isBlobOrFile(v js.Value) bool {
	...
	if blob.Truthy() && v.InstanceOf(blob) {
		return true
	}
	file := js.Global().Get("File")
	if file.Truthy() && v.InstanceOf(file) {
		return true
	}
	return false
}
...
func reportObject(id int) js.Value {
	...
	r.Set("AddDataframe", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		if !dfh.Truthy() {
			return "error: df missing handle"
		}
		df := get(dfh.Int())
		if df == nil {
			return "error: invalid df handle"
		}
	...
	r.Set("SetPrimary", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		if len(args) < 1 || args[0].Type() != js.TypeString {
			return "error: usage SetPrimary(color)"
		}
		if err := rep.SetPrimary(args[0].String()); err != nil {
			return "error: " + err.Error()
		}
		return reportObject(id)
	}))
	...
	r.Set("SetSecondary", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		if len(args) < 1 || args[0].Type() != js.TypeString {
			return "error: usage SetSecondary(color)"
		}
		if err := rep.SetSecondary(args[0].String()); err != nil {
			return "error: " + err.Error()
		}
		return reportObject(id)
	}))
	...
	r.Set("SetAccent", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		if len(args) < 1 || args[0].Type() != js.TypeString {
			return "error: usage SetAccent(color)"
		}
		if err := rep.SetAccent(args[0].String()); err != nil {
			return "error: " + err.Error()
		}
		return reportObject(id)
	}))
	...
	r.Set("SetNeutral", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		if len(args) < 1 || args[0].Type() != js.TypeString {
			return "error: usage SetNeutral(color)"
		}
		if err := rep.SetNeutral(args[0].String()); err != nil {
			return "error: " + err.Error()
		}
		return reportObject(id)
	}))
	...
	r.Set("SetBase100", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		if len(args) < 1 || args[0].Type() != js.TypeString {
			return "error: usage SetBase100(color)"
		}
		if err := rep.SetBase100(args[0].String()); err != nil {
			return "error: " + err.Error()
		}
		return reportObject(id)
	}))
	...
	r.Set("SetInfo", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		if len(args) < 1 || args[0].Type() != js.TypeString {
			return "error: usage SetInfo(color)"
		}
		if err := rep.SetInfo(args[0].String()); err != nil {
			return "error: " + err.Error()
		}
		return reportObject(id)
	}))
	...
	r.Set("SetSuccess", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		if len(args) < 1 || args[0].Type() != js.TypeString {
			return "error: usage SetSuccess(color)"
		}
		if err := rep.SetSuccess(args[0].String()); err != nil {
			return "error: " + err.Error()
		}
		return reportObject(id)
	}))
	...
	r.Set("SetWarning", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		if len(args) < 1 || args[0].Type() != js.TypeString {
			return "error: usage SetWarning(color)"
		}
		if err := rep.SetWarning(args[0].String()); err != nil {
			return "error: " + err.Error()
		}
		return reportObject(id)
	}))
	...
	r.Set("SetErr", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		if len(args) < 1 || args[0].Type() != js.TypeString {
			return "error: usage SetErr(color)"
		}
		if err := rep.SetErr(args[0].String()); err != nil {
			return "error: " + err.Error()
		}
		return reportObject(id)
	}))
...
// Helper: best-effort conversion to string (mirrors Go/Python UDF behavior)
func udfToString(v any) string {
	switch t := v.(type) {
	case nil:
		return ""
	case string:
...
func main() {
	...
	api.Set("Col", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		expr.Set("Split", js.FuncOf(func(this js.Value, a []js.Value) any {
			...
			if name == "" {
				return "error: Split only valid on Col(name)"
			}
			o := js.Global().Get("Object").New()
			o.Set("Type", "split")
			o.Set("Col", name)
